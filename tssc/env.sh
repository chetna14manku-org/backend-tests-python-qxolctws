...
export IMAGE_URL=${IMAGE_URL-quay.io/chetna14manku_org/backend-tests-python-qxolctws:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/chetna14manku-org/backend-tests-python-qxolctws-gitops
